...
class generator:
	...
	def __init__(self):
		...
		self.__inputImage = (not int(isText)) and '<input type="image" src="%s" style="border: 0;">' % self.__alert or ''
...
<small>Ideato da Delta & Bowser © <a href="http://ffmagazine.forumfree.it/">ForumFree Magazine</a></small>''' % (self.__id, self.__inputImage, self.__inputText)
